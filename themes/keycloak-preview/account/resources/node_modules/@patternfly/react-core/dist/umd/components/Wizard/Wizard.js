...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "prop-types", "react", "react-dom", "exenv", "../../helpers/constants", "@patternfly/react-styles", "../../@patternfly/patternfly/components/Wizard/wizard.css.js", "../Backdrop", "../../layouts/Bullseye", "../BackgroundImage", "../Button", "./WizardHeader", "./WizardToggle", "./WizardNav", "./WizardNavItem", 'focus-trap-react'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("prop-types"), require("react"), require("react-dom"), require("exenv"), require("../../helpers/constants"), require("@patternfly/react-styles"), require("../../@patternfly/patternfly/components/Wizard/wizard.css.js"), require("../Backdrop"), require("../../layouts/Bullseye"), require("../BackgroundImage"), require("../Button"), require("./WizardHeader"), require("./WizardToggle"), require("./WizardNav"), require("./WizardNavItem"), require('focus-trap-react'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.propTypes, global.react, global.reactDom, global.exenv, global.constants, global.reactStyles, global.wizardCss, global.Backdrop, global.Bullseye, global.BackgroundImage, global.Button, global.WizardHeader, global.WizardToggle, global.WizardNav, global.WizardNavItem, global.focusTrapReact);
    global.undefined = mod.exports;
  }
})(void 0, function (exports, _propTypes, _react, _reactDom, _exenv, _constants, _reactStyles, _wizardCss, _Backdrop, _Bullseye, _BackgroundImage, _Button, _WizardHeader, _WizardToggle, _WizardNav, _WizardNavItem, FocusTrap) {
  "use strict";
  ...
  var _WizardToggle2 = _interopRequireDefault(_WizardToggle);

  var _WizardNav2 = _interopRequireDefault(_WizardNav);

  var _WizardNavItem2 = _interopRequireDefault(_WizardNavItem);
    ...
    _createClass(Wizard, [{
      ...
      value: function render() {
        ...
        var nav = function nav(isWizardNavOpen) {
          return React.createElement(_WizardNav2.default, {
            ...
            if (step.steps) {
              ...
              return React.createElement(_WizardNavItem2.default, {
                hasChildren: true,
                key: index,
                label: step.name,
              ...
              }, React.createElement(_WizardNav2.default, {
                returnList: true
        ...
        return isOpen && ReactDOM.createPortal(React.createElement(FocusTrap, {
          ...
          className: (0, _reactStyles.css)(_wizardCss2.default.wizard, className),
          role: "dialog",
          "aria-modal": "true",
        ...
        }), React.createElement(_WizardHeader2.default, {
        ...
        }), React.createElement(_WizardToggle2.default, {
          isNavOpen: isNavOpen,
          ...
          className: (0, _reactStyles.css)(_wizardCss2.default.wizardFooter, footerRightAlign && 'pf-m-align-right')
  ...
  _defineProperty(Wizard, "propTypes", {
    ...
    steps: _propTypes2.default.arrayOf(_propTypes2.default.shape({
      ...
      steps: _propTypes2.default.arrayOf(_propTypes2.default.any)
    })).isRequired,
    ...
    lastStepButtonText: _propTypes2.default.string,
    footerRightAlign: _propTypes2.default.bool,
