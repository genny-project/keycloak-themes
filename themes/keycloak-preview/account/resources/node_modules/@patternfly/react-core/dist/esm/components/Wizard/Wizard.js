...
;
var images = (_images = {}, _defineProperty(_images, BackgroundImageSrc.xs, '/assets/images/pfbg_576.jpg'), _defineProperty(_images, BackgroundImageSrc.xs2x, '/assets/images/pfbg_576@2x.jpg'), _defineProperty(_images, BackgroundImageSrc.sm, '/assets/images/pfbg_768.jpg'), _defineProperty(_images, BackgroundImageSrc.sm2x, '/assets/images/pfbg_768@2x.jpg'), _defineProperty(_images, BackgroundImageSrc.lg, '/assets/images/pfbg_1200.jpg'), _defineProperty(_images, BackgroundImageSrc.filter, '/assets/images/background-filter.svg#image_overlay'), _images);
...
function (_React$Component) {
  ...
  _createClass(Wizard, [{
    ...
    value: function render() {
      ...
      return isOpen && ReactDOM.createPortal(React.createElement(FocusTrap, {
      ...
      }, React.createElement(Backdrop, null, React.createElement(Bullseye, null, React.createElement("div", _extends({}, rest, {
        ...
        className: css(styles.wizardFooter, footerRightAlign && 'pf-m-align-right')
      }, React.createElement(Button, {
        variant: "primary",
        type: "submit",
        onClick: this.onNext,
        isDisabled: !isValid
      }, lastStep ? lastStepButtonText : nextButtonText), !firstStep && !activeStep.hideBackButton && React.createElement(Button, {
        variant: "secondary",
        onClick: this.onBack
