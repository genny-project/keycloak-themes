...
var _switchCss = _interopRequireDefault(require("../../@patternfly/patternfly/components/Switch/switch.css.js"));
  ...
  _createClass(Switch, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("label", {
        className: (0, _reactStyles.css)(_switchCss.default.switch, className),
        htmlFor: this.id
      }, _react.default.createElement("input", _extends({}, props, {
        id: this.id,
        className: (0, _reactStyles.css)(_switchCss.default.switchInput),
        type: "checkbox",
        ...
        className: (0, _reactStyles.css)(_switchCss.default.switchToggle)
      }), _react.default.createElement("span", {
        className: (0, _reactStyles.css)(_switchCss.default.switchLabel, _switchCss.default.modifiers.on),
        "aria-hidden": "true"
      }, label), _react.default.createElement("span", {
        className: (0, _reactStyles.css)(_switchCss.default.switchLabel, _switchCss.default.modifiers.off),
        "aria-hidden": "true"
      }, label)) : _react.default.createElement("span", {
        className: (0, _reactStyles.css)(_switchCss.default.switchToggle)
      }, _react.default.createElement("div", {
        className: (0, _reactStyles.css)(_switchCss.default.switchToggleIcon),
        "aria-hidden": "true"
      }, _react.default.createElement(_reactIcons.CheckIcon, {
