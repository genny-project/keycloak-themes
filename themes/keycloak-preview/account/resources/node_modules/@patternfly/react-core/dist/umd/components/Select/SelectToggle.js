...
(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(["exports", "react", "../../@patternfly/patternfly/components/Select/select.css.js", "@patternfly/react-styles", "prop-types", "@patternfly/react-icons", "./selectConstants"], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require("react"), require("../../@patternfly/patternfly/components/Select/select.css.js"), require("@patternfly/react-styles"), require("prop-types"), require("@patternfly/react-icons"), require("./selectConstants"));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.react, global.selectCss, global.reactStyles, global.propTypes, global.reactIcons, global.selectConstants);
    global.undefined = mod.exports;
  }
})(void 0, function (exports, _react, _selectCss, _reactStyles, _propTypes, _reactIcons, _selectConstants) {
  "use strict";
  ...
  function (_Component) {
    ...
    function SelectToggle() {
      ...
      _defineProperty(_assertThisInitialized(_this), "onEscPress", function (event) {
        ...
        if (!isExpanded && event.key === _selectConstants.KeyTypes.Enter) _this.toggle.focus();
      ...
      _defineProperty(_assertThisInitialized(_this), "onKeyDown", function (event) {
        ...
        if (event.key === _selectConstants.KeyTypes.Tab && !isExpanded || event.key !== _selectConstants.KeyTypes.Enter && event.key !== _selectConstants.KeyTypes.Space) return;
    ...
    _createClass(SelectToggle, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement("button", _extends({}, props, {
          ...
          className: (0, _reactStyles.css)(_selectCss2.default.selectToggle, isFocused && _selectCss2.default.modifiers.focus, isHovered && _selectCss2.default.modifiers.hover, isActive && _selectCss2.default.modifiers.active, isPlain && _selectCss2.default.modifiers.plain, className),
          type: type,
        ...
        }, children)), _react2.default.createElement(_reactIcons.CaretDownIcon, {
