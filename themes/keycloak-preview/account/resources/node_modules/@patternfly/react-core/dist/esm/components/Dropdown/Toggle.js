...
function (_Component) {
  ...
  function DropdownToggle() {
    ...
    _defineProperty(_assertThisInitialized(_this), "onEscPress", function (event) {
      ...
      if (_this.props.isOpen && (keyCode === KEY_CODES.ESCAPE_KEY || event.key === 'Tab') && parentRef && parentRef.contains(event.target)) {
        _this.props.onToggle && _this.props.onToggle(false);
  ...
  _createClass(DropdownToggle, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          props = _objectWithoutProperties(_this$props, ["className", "children", "isOpen", "isFocused", "isActive", "isHovered", "isDisabled", "isPlain", "ariaHasPopup", "onToggle", "onEnter", "parentRef", "id", "type"]);
      ...
      return React.createElement("button", _extends({}, props, {
        ...
        className: css(styles.dropdownToggle, isFocused && styles.modifiers.focus, isHovered && styles.modifiers.hover, isActive && styles.modifiers.active, isPlain && styles.modifiers.plain, isDisabled && styles.modifiers.disabled, className),
        type: type || 'button',
