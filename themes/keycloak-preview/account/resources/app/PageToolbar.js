        ...
        return (React.createElement(react_core_1.Toolbar, null,
            this.hasReferrer &&
                React.createElement(react_core_1.ToolbarGroup, { key: 'referrerGroup' },
                    React.createElement(react_core_1.ToolbarItem, { className: "pf-m-icons pf-screen-reader", key: 'referrer' },
            ...
            React.createElement(react_core_1.ToolbarGroup, { key: 'secondGroup' },
                features.isInternationalizationEnabled &&
                    React.createElement(react_core_1.ToolbarItem, { className: "pf-m-icons pf-screen-reader", key: 'locale' },
                        React.createElement(LocaleSelectors_1.LocaleDropdown, null)),
                React.createElement(react_core_1.ToolbarItem, { className: "pf-m-icons pf-screen-reader", key: 'logout' },
                ...
                React.createElement(react_core_1.ToolbarItem, { key: 'kebab', className: "pf-m-mobile" },
                    React.createElement(react_core_1.Dropdown, { isPlain: true, position: "right", toggle: React.createElement(react_core_1.KebabToggle, { onToggle: this.onKebabDropdownToggle }), isOpen: this.state.isKebabDropdownOpen, dropdownItems: kebabDropdownItems })))));
    };
    return PageToolbar;
}(React.Component));
